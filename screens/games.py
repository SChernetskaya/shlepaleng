...
class GamesScreen:
    ...
    def create(self, container):
        ...
        games = [
            ...
            ("🔤 Собери слово", "Собери слово из букв", self.play_spell_game),
            ("🎵 Аудирование", "Прослушай и напиши слово", self.play_listening_game),
            ("⏱️ Спринт", "Ответь на максимальное количество вопросов за время", self.play_sprint_game),
        ]
    ...
    def play_spell_game(self):
        """Игра 'Собери слово' (заглушка)"""
        messagebox.showinfo("Скоро", "Эта игра будет доступна в следующем обновлении!")

    def play_listening_game(self):
        """Игра 'Аудирование' (заглушка)"""
        messagebox.showinfo("Скоро", "Эта игра будет доступна в следующем обновлении!")

    def play_sprint_game(self):
        """Игра 'Спринт' (заглушка)"""
        messagebox.showinfo("Скоро", "Эта игра будет доступна в следующем обновлении!")
